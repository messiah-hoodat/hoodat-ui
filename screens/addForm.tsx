  ...
  render(){
    ...
    <View style={styles.container}>
        <View style={{flex: 0, flexDirection: 'row', marginTop:80} }>
            <TouchableOpacity onPress={() => this.props.navigation.navigate("Hoodat Buds")} style={styles.backButton}>
                <Icon name="chevron-thin-left" size={25} marginBottom="20" color="#828282" />
            </TouchableOpacity>
